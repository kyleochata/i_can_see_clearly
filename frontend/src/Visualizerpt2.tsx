...
//       })
//       const result = await response.json()
//       const { states, iterationCount, comments } = result // Adjust based on backend response
//       setStates(states)
//       setIteration(iterationCount) // Total iterations
//       setComments(comments) // Comments for each step
//     } catch (error) {
//       console.error('Error fetching sorting states:', error)
//     }
//   }
...
//       setHighlight([]) // Clear highlights
//       setCurrentLine(currentStateIndex + 1) // ArrowPointer line
//       setStatus(comments[currentStateIndex]) // Update status with comment
...
//   useEffect(() => {
//     if (codeRef.current) {
//       const lines = codeRef.current.querySelectorAll('code br')
//       lines.forEach((line, index) => {
//         if (index + 1 === currentLine) {
//           line.classList.add('highlight')
//         } else {
